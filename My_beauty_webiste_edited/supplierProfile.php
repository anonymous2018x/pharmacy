...
<a id="smallScreen" data-target="#topMenu" data-toggle="collapse" class="btn btn-navbar">
  ...
  <div class="navbar-inner">
    ...
    <li><a href="sendRequest.php">My account</a></li>
...
<div class="pull-right">
  <a href="editsupplierprofile.php"><span style="font-size: 20px;" class="btn btn-mini btn-primary"><i class="fa fa-pencil-square-o"></i>
        Edit
        </span> </a>
  </div>
  </center>
